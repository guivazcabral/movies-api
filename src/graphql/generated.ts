...
> = {
  getMovies?: Resolver<Array<ResolversTypes["Movie"]>, ParentType, ContextType>;
};
...
> = {
  createMovie?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationcreateMovieArgs, "title" | "year">
  >;
};
...
> = {
  createdMovie?: SubscriptionResolver<
...
> {
  Movie?: {
    ...
    year?: LoaderResolver<Scalars["Int"], Movie, {}, TContext>;
  };
}
